    ...
    return (
      <div className="relative rounded-xl overflow-hidden border border-border">
        ...
        <button
          onClick={clear}
          disabled={disabled}
          className="absolute top-3 right-3 w-8 h-8 rounded-full bg-ink/60 text-white flex items-center justify-center hover:bg-ink/80"
        >
          <X size={15} />
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <p className="text-sm text-ink font-medium">Drag & drop a produce image</p>
        <p className="text-xs text-muted mt-0.5">or choose an option below · JPG, PNG up to 10MB</p>
      </div>
